...
export default (eleventyConfig) => {
    ...
    /**
         * Eleventy filter that converts Markdown content to HTML.
         *
         * This filter is useful when rendering Markdown strings coming from
         * data files (JSON/JS), CMS fields, or frontmatter properties
         * inside Nunjucks or Liquid templates.
         *
         * @param {string} content - Raw Markdown string to be rendered.
         * @returns {string} HTML output generated by the Markdown renderer.
         *
         * @example
         * {{ myMarkdownText | markdown | safe }}
         */
    ...
    // Seřazení kategorií podle pole 'sort' v frontmatteru
    ...
    // Seřazení vnořených položek (uvnitř listu) podle jejich pole 'sort'
    eleventyConfig.addFilter("sortByItemSort", (arr) => {
        if (!arr) return [];
        return arr.slice().sort((a, b) => {
    ...
    eleventyConfig.addFilter("debug", (content) => {
        ...
        return ""; // Vrátí prázdný řetězec, aby nic nevypsal na web
    });
